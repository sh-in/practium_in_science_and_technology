...
from tensorflow.keras.layers import Dense, Dropout, Flatten, Conv2D, MaxPool2D, Activation, Add, GlobalAveragePooling2D, BatchNormalization
...
model = Sequential(
    BatchNormalization(),
    Activation(relu),
    Conv2D(64, kernel_size=7, strides=2, padding="same", use_bias=False, input_shape=input_shape),
