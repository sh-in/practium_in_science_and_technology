...
for dataset in datasets:
    print("Model: {}, dataset: {}".format(39+datasets.index(dataset), dataset))
    ...
    for epoch in range(1, epochs + 1):
        ...
        #     break
        if epoch == epochs:
            score_list.append([train_acc, train_loss, val_acc, val_loss])
    ...
    plt.savefig(output_path+"loss" + str(39+datasets.index(dataset)) + ".png")
    ...
    plt.xlabel("epoch")
    plt.ylabel("accuracy")
    plt.savefig(output_path+"acc" + str(39+datasets.index(dataset)) + ".png")
    ...
    submissions.to_csv(output_path + "transformer_submissions" + str(39+datasets.index(dataset)) +  ".csv", index=False, header=True)
...
c=0
for i in score_list:
    print("{:5}{:14.5}{:13.5}{:12.5}{:11.5}".format(c+39, i[0], i[1], i[2], i[3]))
    c+=1
