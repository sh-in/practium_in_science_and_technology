...
train_preds = pd.DataFrame({"lstm_and_gru": preds})
train_preds.to_csv("../../../../output/Tabular_Playground_Series_Apr_2022/result/transformer_comp/ensemble/lstm_and_gru_train.csv", index=False, header=True)
...
preds = np.array(preds)
test_preds = pd.DataFrame({"lstm_and_gru": preds})
test_preds.to_csv("../../../../output/Tabular_Playground_Series_Apr_2022/result/transformer_comp/ensemble/lstm_and_gru_test.csv", index=False, header=True)
print(test_preds)
