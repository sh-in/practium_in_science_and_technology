# Copy of the base LSTM + Attention.
...
class LSTM_Attention(nn.Module):
    ...
    def forward(self, x):
        ...
        attn_hidden = F.hardtanh(self.dropout2(self.cat_linear(torch.cat([context, biout], dim=1))))
...
if os.path.exists(output_path + "attention/torch/test1") == False:
    os.makedirs(output_path + "attention/torch/test1")
output_path = output_path + "attention/torch/test1/"
